...
const Submenu = ({active = false, sidebarActiveMenuId, modules, t, setSubmenu, breadcrumbs}) => {
    ...
    return (
        <SubmenuStyle {...{active}} className={"submenu"} onMouseEnter={() => setSubmenu(true)}
                            ...
                            <nav className={"submenu__links"}>
                                {get(department, "pages", []).map((page) => (
                                    <NavLink
                                        ...
                                        key={get(page, "id")}
                                        to={
                                            "/" + getUrlFromName(`${slugify(get(modules.find((module) => isEqual(get(module, "id"), sidebarActiveMenuId)), "name", "/"))} ${slugify(get(department, "name", ""))} ${slugify(get(page, "name", "#"))}`)
                                        }
...
export default withTranslation('pdp')(connect(mapStateToProps, null)(Submenu));