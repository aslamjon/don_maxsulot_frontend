...
function* setTempData(action) {
    ...
    try {
        yield put({ type: Actions.TEMP_DATA.SUCCESS, payload: { item, storeName } });
    } catch (e) {
        yield put({ type: Actions.TEMP_DATA.FAILURE, payload: { item, storeName } });
    }
}
