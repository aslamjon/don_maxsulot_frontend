              ...
              <div {...column.getHeaderProps()} className="th">
                <ContextMenuTrigger id={get(column, "id")} HoldToDisplay={"-1"}>
                  <div className="d-flex">
                    <Icon
                      size="sm"
                      mainClassName="headerIcon"
                      icon={`icon-${slugify(column.render("type"))}`}
                    />
                    <div
                ...
                <ContextMenu id={get(column, "id")}>
                  ...
                  {get(column, "pinned", false) ? (
                    <MenuItem
                      data={{ foo: "bar" }}
                      onClick={() => pinOrUnpinColumn(get(column, "id"), false)}
                    >
                    ...
                    <MenuItem
                      data={{ foo: "bar" }}
                      onClick={() => pinOrUnpinColumn(get(column, "id"), true)}
                    >
                      <Icon icon="icon-pin" color="#353945" />
                  ...
                  <div className="menu__footer">
                    {!get(column, "root", false) && (
                      <MenuItem
                        data={{ foo: "bar" }}
                        onClick={() => hideOrShowColumn(get(column, "id"), false)}
                      >
