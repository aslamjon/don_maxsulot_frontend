...
export const SelectStyled = styled.div`
  .select {
    ...
    &__body {
      ...
      ${({defaultHideAnimation}) => defaultHideAnimation ? "animation: hideAnim 0.1s forwards;" : "transform: scale(0);"} //animation: hideAnim 0.1s forwards;
      position: absolute;
      ...
      &__options {
        ...
        &__option {
          ...
          ${({optionsDisabled}) => optionsDisabled && css`
            background: #777e9129;
            cursor: not-allowed;
