...
import { getSelectOptionsListFromData, showError } from "../../../../utils";
...
const CreateContainer = ({ getFormDataRequest, addRoleFormData, addRoleRequest, ...rest }) => {
  ...
  console.log(addRoleFormData, "addRoleFormData");
        ...
        <FormDemo
          ...
          footer={
            <Flex justify={"flex-end"} className={"buttons mt-30"}>
              <Button
                className={"cancelBtn"}
                onCLick={() => history.push("/setting/auth/roles")}
                outlineDanger
              >
                CANCEL
              </Button>
              ...
              <Col xs={6}>
                <Field
                  ...
                  options={getSelectOptionsListFromData(
                    get(addRoleFormData, "result.data.roleTypes", []),
                    "name",
                    "name"
                  )}
                  name={"roleType"}
