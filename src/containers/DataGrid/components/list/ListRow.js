...
const Style = styled.div`
  .list {
    ...
    &__head {
      ...
      &__phone, &__priority, &__action, &__call, &__message {
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    &__body {
      ...
      &__row {
        ...
        &__name, &__phone, &__priority, &__action, &__call, &__message {
          display: flex;
          justify-content: center;
        }
                ...
                <div className="list__head">
                    <div className="list__head__status">
                        <Button
                            ...
                            {head.status}
                            <Icon icon="icon-bottom-arrow" listClassName="bottomArrow"
                                                ...
                                                <Draggable
                                                    ...
                                                    {(provided, snapshot) => (
                                                        <div
                                                            ...
                                                            {item.content == 'phone' &&
                                                            <Icon icon="icon-dots" className="dots"/>}
                                                            {item.content}
                                                            ...
                                                            {item.content == 'phone' &&
                                                            <Icon icon="icon-x-close" size="xs" className="xClose"
                                                                  color="white"/>}
                                                        </div>
                                                    )}
                                                </Draggable>
