                ...
                { status === "info" 
                    ...
                    : status === "success" 
                        ...
                        : status === "warning" 
                            ...
                            : status === "error" ? <img src={error} alt="error" /> : null } 
            </span>
            <span className="message">{ message }</span>
            { close && <Icon icon="icon-x-close" mainClassName="close" onClick={() => close()}/> }
            { yes && no && <div className="yesAndNoContainer">
                <div className="yes" onClick={() => yes()}>Yes</div>
                <div className="no" onClick={() => no()}>No</div>
            </div> } 
        </MessageStyled>
    )
}
