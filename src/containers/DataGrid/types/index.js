export const TYPES = [
        ...
        name: 'DATE', types: [
            {
                ...
                children: [
                    ...
                    {
                        label: 'Next', value: 'NEXT', hasNext: true,
                        children: [
                            {label: 'Day', value: 'DAY'},
                            {label: 'Week', value: 'WEEK'},
                            {label: 'Month', value: 'MONTH'},
            ...
            {
                label: 'is not', value: 'NOT', children: [
                    {label: 'Today', value: 'TODAY'},
                    {label: 'Yesterday', value: 'YESTERDAY'},
                    {label: 'Tomorrow', value: 'TOMORROW'},
                    {
                        ...
                        value: 'LAST',
                        hasNext: true,
                        children: [{label: 'Day', value: 'DAY'}, {label: 'Week', value: 'WEEK'}, {
                            label: 'Month',
                            value: 'MONTH'
                        }, {label: 'Year', value: 'YEAR'}]
                    },
    ...
    {
        name: 'LABELS', types: [
            {label: 'Is', value: 'ANY', children: [{label: 'Any', value: 'ANY'}, {label: 'All', value: 'ALL'}]},
            {label: 'Is not', value: 'NOT_ANY', children: [{label: 'Any', value: 'ANY'}, {label: 'All', value: 'ALL'}]},
            {label: 'Is set', value: 'IS_SET', isLastSelect: true},
            {label: 'is not set', value: 'IS_NOT_SET', isLastSelect: true}
        ]
    },
    {
        name: 'SHORT_TEXT', types: [
    ...
    {
        name: 'LONG_TEXT', types: [
            {label: 'Contains', value: 'EQ',},
            {label: 'Does not contain', value: 'NOT',},
            {label: 'Is set', value: 'IS_SET', isLastSelect: true},
            {
                label: 'is not set',
                value: 'IS_NOT_SET', isLastSelect: true
            }
        ]
    },
    {
