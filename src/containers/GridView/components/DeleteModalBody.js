...
const  DeleteModalBody = ({
    ...
    confirmText="Flutter Development", id= null, remove=() => {}, cancel=() => {}}) => {
    ...
    return (
        <DeleteModuleStyled>
            ...
            <Label className="del-label" isUpperCase="" >
                <div className="moduleName">TYPE {confirmText}</div>
                <Input className={"input"} value={value} onChange={(e)=>setValue(e.target.value)}/>
            </Label>
            <div className="buttons">
                <Button className="buttons__cancel" outlineDanger onCLick={cancel}>Cancel</Button>
                <Button className="buttons__yes" danger={isEqual(value, confirmText)} disabled={!isEqual(value ,confirmText)} onCLick={() => remove(id)} >Yes, delete</Button>
            </div>
        </DeleteModuleStyled>
    )
}
