    ...
    return (
        <OptionsOfSelectStyled {...props}>
            <section className="head">
                ...
                <div className="head__queastion"><Icon icon="icon-question" mainClassName="IconQestion" /></div>
            </section>
            <main className="main">
                ...
                <section className="main__body">                    
                    {isArray(optoinsValue) && optoinsValue && optoinsValue.map((value, index) => (
                        <div className="main__body__option" key={`${index + new Date().getTime()}`} data-index={index} onClick={clickOption}>{value.option}</div>
                    ))}
                </section>
            </main>
